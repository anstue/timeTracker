...
public interface TimeEntityDao {
    ...
    @Query("select * from timeEntity where accountEntityId = :accountEntityId order by start asc") //start asc sorting important, open timeentry expected at last item
